...
# convert to list of 20 (one matrix per year) to allow hatchery releases to vary annually
spring_hatchery_release <- rep(list(spring_hatchery_release), 20)
names(spring_hatchery_release) <- c(1:20)
