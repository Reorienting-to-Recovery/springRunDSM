...
1)  Each year, if model is run deterministicly, there are 307650 hatchery adults initiated into the model based on (CWT data?). Hatchery adults are split between tribs based on values from `springRunDSM::hatchery_allocation`
...
fecundity_table <- tibble(`Age in Model` = c(2, 2, 3, 3, 4, 4, 5),
                          ...
                          Fecundity = c((springRunDSM::params$spawn_success_fecundity - ((69.1 - 50.9) * 10 * 7.8)), 
                                        (springRunDSM::params$spawn_success_fecundity - ((69.1 - 48.9) * 10 * 7.8)), 
                                        springRunDSM::params$spawn_success_fecundity, 
                                        (springRunDSM::params$spawn_success_fecundity - ((69.1 -  67.1) * 10 * 7.8)), 
                                        (springRunDSM::params$spawn_success_fecundity - ((69.1 - 83.0) * 10 * 7.8)),
                                        (springRunDSM::params$spawn_success_fecundity - ((69.1 - 81.0) * 10 * 7.8)),
                                        (springRunDSM::params$spawn_success_fecundity - ((69.1 - 85) * 10 * 7.8)))) |> 
...
spring_hatchery_release = matrix(0, nrow = 31, ncol = 4, 
...
spring_hatchery_release<- array(rep(spring_hatchery_release, 20), 
                              c(31, 4, 20),
                              dimnames = list(springRunDSM::watershed_labels,
                                              c("s", "m", "l", "xl"),
                                              1:20))
