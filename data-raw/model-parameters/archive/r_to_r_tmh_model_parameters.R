...
r_to_r_tmh_params <- list(
  ...
  spawning_habitat = DSMhabitat::sr_spawn$r_to_r_tmh,
  inchannel_habitat_fry = DSMhabitat::sr_fry$r_to_r_tmh, # vary by run
  inchannel_habitat_juvenile = DSMhabitat::sr_juv$r_to_r_tmh, # vary by run
  floodplain_habitat = DSMhabitat::sr_fp$r_to_r_tmh, # vary by run
